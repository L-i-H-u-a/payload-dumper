...
class DynamicPartitionMetadata(_message.Message):
    ...
    def __init__(self, groups: _Optional[_Iterable[_Union[DynamicPartitionGroup, _Mapping]]] = ..., snapshot_enabled: bool = ..., vabc_enabled: bool = ..., vabc_compression_param: _Optional[str] = ..., cow_version: _Optional[int] = ..., vabc_feature_set: _Optional[_Union[VABCFeatureSet, _Mapping]] = ..., compression_factor: _Optional[int] = ...) -> None: ...
